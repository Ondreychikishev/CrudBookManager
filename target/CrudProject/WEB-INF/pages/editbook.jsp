...
<c:url var="addAction" value="/book/edit"/>
    ...
    <table class="features-table">
        ...
        <tr>
            <td colspan="2" style="text-align: center">
                <input type="submit" value="<spring:message text="Edit Reading"/>"/>
            </td>
        </tr>
    </table>
</form:form>
<br/>
<br/>
<h1>Replace with a new edition</h1>
...
<form:form action="${addAction}" commandName="book">
    <table class="features-table">
        ...
        <tr>
            <td class="param"><form:label path="readAlready"><spring:message text="Read_Already"/></form:label></td>
            <td>
                <form:checkbox path="readAlready" value="false" disabled="true"/>
            </td>
        </tr>
        <tr>
            <td colspan="2" style="text-align: center">
                <input type="submit" value="<spring:message text="Edit Edition"/>"/>
            </td>
        </tr>
    </table>
</form:form>
